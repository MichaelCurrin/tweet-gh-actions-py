...
- This is a template project - get a copy of it and then customize it for your needs.
...
- This comes with a short Python script - [tweet.py](/tweepy.py). This is app that is run in the workflow, but you can of course update it or replace it with a script for another library or programming language.
